...
//此文件 做了些更改，以后找到替换方案再更新
///wp-content/plugins/masterstudy-lms-learning-management-system-pro/stm-lms-templates/manage_course/forms/js/lesson.php
ob_start(); ?>
            ...
            mounted() {
                ...
                WPCFTO_EventBus.$on('STM_LMS_Curriculum_item', function (item) {
                    ...
                    this.$http.get(url).then(function (response) {
                        ...
                        if (json_meta['mcv_alivod_vid']) {
                            _this.$set(_this.fields, 'mcv_alivod_vid', json_meta['mcv_alivod_vid']);
                        } else {
                            _this.$set(_this.fields, 'mcv_alivod_vid', '');
                        }
