 ...
 *
 */
if ( ! class_exists( 'MCSF_Comment_Metabox' ) ) {
  class MCSF_Comment_Metabox extends MCSF_Abstract{
            ...
            foreach ( $this->sections as $section ) {
              ...
              if ( ! empty( $section['fields'] ) ) {
                ...
                foreach ( $section['fields'] as $field ) {
                  ...
                  MCSF::field( $field, $this->get_meta_value( $comment->comment_ID, $field ), $this->unique, 'comment_metabox' );
