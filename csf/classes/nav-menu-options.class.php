 ...
 *
 */
if ( ! class_exists( 'MCSF_Nav_Menu_Options' ) ) {
  class MCSF_Nav_Menu_Options extends MCSF_Abstract{
    ...
    public function wp_edit_nav_menu_walker( $class, $menu_id ) {
      ...
      if( version_compare( $wp_version, '5.4.0', '<' ) ) {
        ...
        if ( ! class_exists( 'MCSF_Walker_Nav_Menu_Edit' ) ) {
          MCSF::include_plugin_file( 'functions/walker.php' );
        }

        return 'MCSF_Walker_Nav_Menu_Edit';
        ...
        foreach ( $this->sections as $section ) {
          ...
          if ( ! empty( $section['fields'] ) ) {
            ...
            foreach ( $section['fields'] as $field ) {
              ...
              MCSF::field( $field, $this->get_meta_value( $menu_item_id, $field ), $this->unique .'['. $menu_item_id .']', 'menu' );
