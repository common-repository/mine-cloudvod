      ...
      echo '<div class="csf csf-metabox'. $theme . $class .'">';
        ...
        echo '<div class="csf-wrapper'. $show_all .'">';
          ...
          if( $has_nav ) {
            ...
            echo '<div class="csf-nav csf-nav-normal csf-nav-metabox" data-unique="'. $this->unique .'">';
          ...
          echo '<div class="csf-content">';
            ...
            foreach( $this->sections as $section ) {
              ...
              echo '<div id="csf-section-'. $this->unique .'_'. $section_key .'" class="csf-section hidden'. $onload .'">';
            ...
            if( ! empty( $this->args['show_restore'] ) ) {
              ...
              echo '<span class="button csf-button-restore">'. esc_html__( 'Restore', 'mine-cloudvod' ) .'</span>';
              echo '<span class="button csf-button-cancel">'. sprintf( '<small>( %s )</small> %s', esc_html__( 'update post for restore ', 'mine-cloudvod' ), esc_html__( 'Cancel', 'mine-cloudvod' ) ) .'</span>';
              echo '</label>';
              echo '</div>';
    ...
    public function save_meta_box( $post_id ) {
      ...
      if ( wp_verify_nonce( csf_get_var( 'csf_metabox_nonce' ), 'csf_metabox_nonce' ) ) {
        ...
        if( empty( $request ) || ! empty( $request['_restore'] ) ) {
          ...
          if( $this->args['data_type'] !== 'serialize' ) {
            if(isset($_POST['___'.$this->unique])){
              foreach ( $_POST['___'.$this->unique] as $key => $value ) {
