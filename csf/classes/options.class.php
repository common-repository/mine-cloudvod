...
if( ! class_exists( 'MCSF_Options' ) ) {
  ...
  class MCSF_Options extends MCSF_Abstract {
    ...
    public function ajax_save() {
      ...
      wp_send_json_error( array( 'success' => false, 'error' => esc_html__( 'Error while saving.', 'mine-cloudvod' ) ) );
    ...
    public function set_options() {
      ...
      if( wp_verify_nonce( csf_get_var( 'csf_options_nonce' ), 'csf_options_nonce' ) ) {
        ...
        if( ! empty( $transient['csf_import_data'] ) ) {
          ...
          $this->notice = esc_html__( 'Success. Imported backup options.', 'mine-cloudvod' );
          ...
          $this->notice = esc_html__( 'Default options restored.', 'mine-cloudvod' );
          ...
          $this->notice = esc_html__( 'Default options restored for only this section.', 'mine-cloudvod' );
      ...
      echo '<div class="csf csf-options'. $theme . $class . $wrapper_class .'" data-slug="'. $this->args['menu_slug'] .'" data-unique="'. $this->unique .'">';
        ...
        echo '<div class="csf-header-inner">';
          ...
          echo '<div class="csf-header-right">';
            ...
            echo ( $has_nav && $this->args['show_all_options'] ) ? '<div class="csf-expand-all" title="'. esc_html__( 'show all options', 'mine-cloudvod' ) .'"><i class="fa fa-outdent"></i></div>' : '';

            echo ( $this->args['show_search'] ) ? '<div class="csf-search"><input type="text" name="csf-search" placeholder="'. esc_html__( 'Search option(s)', 'mine-cloudvod' ) .'" autocomplete="off" /></div>' : '';

            echo '<div class="csf-buttons">';
            echo '<input type="submit" name="'. $this->unique .'[_nonce][save]" class="button button-primary csf-save'. $ajax_class .'" value="'. esc_html__( 'Save', 'mine-cloudvod' ) .'" data-save="'. esc_html__( 'Saving...', 'mine-cloudvod' ) .'">';
            ...
            echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="csf_transient[reset]" class="button button-secondary csf-warning-primary csf-reset-all csf-confirm" value="'. esc_html__( 'Reset All', 'mine-cloudvod' ) .'" data-confirm="'. esc_html__( 'Are you sure to reset all options?', 'mine-cloudvod' ) .'">' : '';
            echo '</div>';
          ...
          echo '<div class="csf-content">';
            ...
            foreach( $this->pre_sections as $section ) {
              ...
              if( ! empty( $section['fields'] ) ) {
                ...
                echo '<div class="csf-no-option csf-text-muted">'. esc_html__( 'No option provided by developer.', 'mine-cloudvod' ) .'</div>';
        ...
        if( ! empty( $this->args['show_footer'] ) ) {
          ...
          echo '<div class="csf-buttons">';
          echo '<input type="submit" name="csf_transient[save]" class="button button-primary csf-save'. $ajax_class .'" value="'. esc_html__( 'Save', 'mine-cloudvod' ) .'" data-save="'. esc_html__( 'Saving...', 'mine-cloudvod' ) .'">';
          echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="csf_transient[reset_section]" class="button button-secondary csf-reset-section csf-confirm" value="'. esc_html__( 'Reset Section', 'mine-cloudvod' ) .'" data-confirm="'. esc_html__( 'Are you sure to reset this section options?', 'mine-cloudvod' ) .'">' : '';
          echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="csf_transient[reset]" class="button button-secondary csf-warning-primary csf-reset-all csf-confirm" value="'. esc_html__( 'Reset All', 'mine-cloudvod' ) .'" data-confirm="'. esc_html__( 'Are you sure to reset all options?', 'mine-cloudvod' ) .'">' : '';
          echo '</div>';
