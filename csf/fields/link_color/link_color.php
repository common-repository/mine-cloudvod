...
if ( ! class_exists( 'MCSF_Field_link_color' ) ) {
  class MCSF_Field_link_color extends MCSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'mine-cloudvod' ),
        'hover'    => esc_html__( 'Hover', 'mine-cloudvod' ),
        'active'   => esc_html__( 'Active', 'mine-cloudvod' ),
        'visited'  => esc_html__( 'Visited', 'mine-cloudvod' ),
        'focus'    => esc_html__( 'Focus', 'mine-cloudvod' )
      );
